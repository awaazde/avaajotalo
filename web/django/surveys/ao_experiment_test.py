...
INBOUND = {"T1":"7930142001", "T2":"7930142002", "T3":"7930142003", "T4":"7930142004"}
# Neil and Jig
EITHER = ["9586550654", "9824419679"]
# Anji
AM = ["9687027682"]
# MAM
PM = ["9537160173", "9537160174"]
GROUPS = [["E1","P1","E2","P2"], ["E2","P2","E1","P1"], ["P1","E1","P2","E2"], ["P2","E2","P1","E1"]]
SUBJ_GROUPS = {}

AM_START = timedelta(hours=8)
AM_END = timedelta(hours=10)
PM_START = timedelta(hours=18)
PM_END = timedelta(hours=20)
...
SURVEYS = ["T1_BCALL", "T2_BCALL", "T3_BCALL", "T4_BHOLD"]

STUDY_START = datetime(year=2010, month=7, day=26)
