...
****************************************************************************
'''
OUTPUT_FILE_DIR='/home/wog/reports/'
...
def create_demo_survey():
    s = Survey(name='WoG DEMO_'+Survey.INBOUND_DESIGNATOR, number=NUMBER, dialstring_prefix=PREFIX, dialstring_suffix=SUFFIX, complete_after=0)
    s.save()
