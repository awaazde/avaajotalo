...
public class SoundWidget {
	...
	public SoundWidget()
	{
		sound = new HTML("<object width=\"200\" height=\"24\" type=\"application/x-shockwave-flash\" data=\"ao/swf/player.swf\" id=\"audioplayer2\">"  +
		    ...
		    "<param name=\"FlashVars\" value=\"playerID=2&amp;soundFile=dummy.mp3\"  />" +
	...
	{
		sound.setHTML("<object width=\"200\" height=\"24\" type=\"application/x-shockwave-flash\" data=\"ao/swf/player.swf\" id=\"audioplayer2\">"  +
    "<param name=\"movie\" value=\"ao/swf/player.swf\" />" +
