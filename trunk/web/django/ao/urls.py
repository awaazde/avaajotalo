...
urlpatterns = patterns('',
    ...
    (r'^download/streamreport/(?P<group_id>\d+)/$', 'awaazde.streamit.views.downloadstreamreport'),
    ...
    (r'^creategroup/$', 'awaazde.streamit.views.creategroup'),
    (r'^group/$', 'otalo.ao.views.group'),
    (r'^members/(?P<group_id>\d+)/$', 'awaazde.streamit.views.members'),
    (r'^update/member/(?P<membership_id>\d+)/$', 'awaazde.streamit.views.updatemembership'),
    (r'^addmembers/$', 'awaazde.streamit.views.addmembers'),
