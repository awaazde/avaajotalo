...
REQUESTED_CHAN_UNAVAILABLE = 'REQUESTED_CHAN_UNAVAIL';
NORMAL_CIRCUIT_CONGESTION = 'NORMAL_CIRCUIT_CONGESTION';
NORMAL_TEMPORARY_FAILURE = 'NORMAL_TEMPORARY_FAILURE';
PROTOCOL_ERROR = 'PROTOCOL_ERROR';

TECHNICAL_ERRORS = {REQUESTED_CHAN_UNAVAILABLE, NORMAL_CIRCUIT_CONGESTION, NORMAL_TEMPORARY_FAILURE, PROTOCOL_ERROR};
