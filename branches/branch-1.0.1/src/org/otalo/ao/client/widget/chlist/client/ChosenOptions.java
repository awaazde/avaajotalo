...
public class ChosenOptions {
    ...
    private boolean isHideNoResult;
    private boolean isAddNewOptionVal;
    ...
    public boolean isHideNoResult() {
		return isHideNoResult;
	}

	public void setHideNoResult(boolean isHideNoResult) {
		this.isHideNoResult = isHideNoResult;
	}
	...
	public boolean isAddNewOptionVal() {
		return isAddNewOptionVal;
	}

	public void setAddNewOptionVal(boolean isAddNewOptionVal) {
		this.isAddNewOptionVal = isAddNewOptionVal;
	}
